...
export default class FirebaseStorageUploadUrl extends BlueprintNode {
    ...
    async run(ctx: BlueprintContext): Promise<ResponseContext> {
        ...
        try {
            ...
            const result = await this.getUploadUrl(app, bucketName, remoteFileName);
    ...
    async getUploadUrl(app: any, bucketName: string, remoteFileName: string) {
